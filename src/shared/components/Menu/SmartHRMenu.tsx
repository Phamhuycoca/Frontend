...
const dashboardChildren = [
  ...
  { key: "hr", label: <span>HR Dashboard <BadgeTag text="New" /></span> },
  { key: "payroll", label: <span>Payroll Dashboard <BadgeTag text="New" /></span> },
  { key: "recruitment", label: <span>Recruitment Dashboard <BadgeTag text="New" /></span> },
  { key: "attendance", label: <span>Attendance Dashboard <BadgeTag text="New" /></span> },
  { key: "finance", label: <span>Finance Dashboard <BadgeTag text="New" /></span> },
  { key: "itadmin", label: <span>IT Admin Dashboard <BadgeTag text="New" /></span> },
  { key: "asset", label: <span>Asset Dashboard <BadgeTag text="New" /></span> },
  { key: "helpdesk", label: <span>Help Desk Dashboard <BadgeTag text="New" /></span> },
];
...
const items = [
  {
    ...
    label: <span>Dashboard <BadgeTag text="Hot" /></span>,
